...
namespace NewsReaderExpress
{
    public partial class PanoramaPage1 : PhoneApplicationPage
    {
        ...
        private void TodaysPick_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/TodaysPick.xaml", UriKind.RelativeOrAbsolute));
        }

        private void National_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/National.xaml", UriKind.RelativeOrAbsolute));
        }

        private void Business_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/Business.xaml", UriKind.RelativeOrAbsolute));
        }

        private void Sports_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/Sports.xaml", UriKind.RelativeOrAbsolute));
        }


        private void International_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/International.xaml", UriKind.RelativeOrAbsolute));
        }

        private void Entertainment_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/Entertainment.xaml", UriKind.RelativeOrAbsolute));
        }

        private void Tech_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/Tech.xaml", UriKind.RelativeOrAbsolute));
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            SndMovies.ItemsSource = SharedInformation.getInstance().getNewsData();
            try { NewsItem("http://www.newvision.co.ug/section/53-435-today-s-Pick.html"); }
            catch { }
        ...
        private void Public_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/ShowPublicNews.xaml", UriKind.RelativeOrAbsolute));
        }

        private void Public_Click(object sender, EventArgs e)
        {
            NavigationService.Navigate(new Uri("/Public.xaml", UriKind.RelativeOrAbsolute));
        }

        private void GoFullStory(object sender, System.Windows.Input.GestureEventArgs e)
        {
            string headLine = (SndMovies.SelectedItem as Datum).Heading;
            string details = (SndMovies.SelectedItem as Datum).Details;
            string imagePath = (SndMovies.SelectedItem as Datum).ImagePath;
